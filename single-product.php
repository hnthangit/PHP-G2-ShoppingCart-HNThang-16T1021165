						...
						<div class="col-lg-6 col-12">
							<div class="wn__fotorama__wrapper">
								<div class="fotorama wn__fotorama__action" data-nav="thumbs">
									<a href="1.jpg"><img src="<?php echo $book->image ?>" alt=""></a>
							...
							<div class="product__info__main">
								...
								<div class="box-tocart d-flex">
									...
									<div class="addtocart__actions">
										<button data-id="<?php echo $book->id ?>" data-title="<?php echo $book->title ?>" data-price="<?php echo $book->price ?>" data-image="<?php echo $book->image ?>" class="tocart" type="submit" title="Add to Cart">Add to Cart</button>
									</div>
